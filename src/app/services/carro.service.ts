...
export class CarroService {
  ...
  API = 'http://localhost:8082/api/carro';
  ...
  listar(
    ...
    return this.http.get<Paginacao<Carro>>(this.API, { params });
  }
  ...
  atualizar(carro: Carro, id: number): Observable<string> {
    return this.http.patch<string>(`${this.API}/${id}`, carro, {
